...
public class Strings {
    ...
    public static final String WIDGET_MULTIAUTOCOMPLETETEXTVIEW = "android.widget.MultiAutoCompleteTextView";
    public static final String VIEW_VIEW = "android.view.View";
}
